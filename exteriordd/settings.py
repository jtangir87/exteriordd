"""
Django settings for exteriordd project.
...
SECRET_KEY = "iy*p46y*e^ryodj55rmq@ci4)6&8^qzf$i&ltgc!@)zz*0=k1u"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "pages.context_processors.estimate_form_processor",
            ],
        },
    },
]

WSGI_APPLICATION = "exteriordd.wsgi.application"
